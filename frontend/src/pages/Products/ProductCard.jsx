      ...
      <section className='relative'>
        <Link to={`/product/${p._id}`}>
          ...
          <img 
            ...
            src={p.image} 
            alt={p.name} 
            style={{height: '240px', width:'400px', objectFit: "cover"}} />
        </Link>
        <HeartIcon product={p} />
      </section>
      <div className='pb-5'>
        <div className='flex justify-between'>
          <h5 className='mb-2 text-xl text-white dark:text-white pt-2'>{p?.name}</h5>
          <p className="font-semibold text-pink-500 pt-2">
        ...
        <section className="flex justify-between items-center">
            ...
            text-center text-white bg-pink-700 rounded-lg hover:bg-pink-800 
