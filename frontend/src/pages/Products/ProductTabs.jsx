          ...
          <div className="mt-4">
            {userInfo ? (
              <form onSubmit={handleSubmit}>
                ...
                <button type='submit' disabled={loadingProductReview} className='bg-pink-600
                text-white py-2 px-4 rounded-lg'>Submit</button>
              </form>
            ) : (
        ...
        <>
          ...
          <div>
            {product.reviews.map((review) => (
              ...
              xl:ml-[2rem] sm:ml-[0rem] xl:w-[50rem] sm:w-[24rem] mb-5">
