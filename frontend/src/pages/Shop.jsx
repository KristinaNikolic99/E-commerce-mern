...
import {
    setCategories, 
    setProducts, 
    setChecked} from '../redux/features/shop/shopSlice';
...
const Shop = () => {
    ...
    useEffect(() => {
        if(!checked.length || !radio.length) {
            if(!filteredProductsQuery.isLoading) {
                // Filter product based on both checked categories and price filter
    ...
    const handleCheck = (value, id) => {
        const updatedChedked = value ? [...checked, id] : checked.filter((c) => c !== id);
        dispatch(setChecked(updatedChedked));
    };
            ...
            <div className='bg-[#151515] p-3 mt-2 mb-2'>
                    ...
                    {uniqueBrands?.map((brand, index) => (
                            <div key={index} className='flex items-center mr-4 mb-5'>
                                <input 
                                    ...
                                    dark:focus:ring-pink-600 dark:ring-offset-gray-800 
                ...
                <div className='p-5 w-[15rem]'>
                    <input 
                        ...
                        className="w-full px-3 py-2 placeholder-gray-400 
                        border rounded-lg focus:outline-none focus:ring
